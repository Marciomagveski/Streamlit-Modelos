# Tecnica para uso em Regressão Linear
...
with col2:
    ...
    ax.plot(X, modelo.predict(X), color='red') #Criando linha de regressão
    st.pyplot(fig)


st.header("Informe o Valor Anual da Franquia:")
novo_valor = st.number_input("Insira o Valor da Franquia", min_value=1.0, max_value=999999999.0, value=1500.0, step=100.00)
