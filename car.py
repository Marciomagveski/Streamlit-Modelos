...
def load_data_and_model():
    ...
    X_train, X_teste, y_train, y_test = train_test_split(X_encoded,y, test_size=0.3, random_state=42)
...
#Contruir Interface do usuário

st.title("Previsão de Qualidade de Veículo")
st.write(f"A Acuracia do modelo: {acuracia:.2f}")
